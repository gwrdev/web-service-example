...
import org.gwilymgrp.ws.product_service.types.ProductResponse;

public class ProductServiceImpl {
    public ProductResponse getProductDetails(org.gwilymgrp.ws.product_service.types.ProductRequest request) {
